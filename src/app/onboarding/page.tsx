...
type Step = 'choose' | 'create' | 'name' | 'join' | 'chat'
        ...
        <div>
          ...
          {step !== 'chat' && (
            <div style={{ marginBottom: '40px' }}>
              <span style={{ fontSize: '22px', fontWeight: 700, color: '#1a1a18', letterSpacing: '-0.5px', fontFamily: 'inherit' }}>
                Roll<span style={{ fontWeight: 300, color: '#9b9890' }}>able</span>
              </span>
            </div>
          )}
          ...
          {step === 'name' && (
            <div className="animate-fade-in-up">
              <p style={{ margin: '0 0 8px', fontSize: '13px', color: '#9b9890', letterSpacing: '0.04em', textTransform: 'uppercase', fontWeight: 500 }}>Nice to meet you</p>
              <h1 style={{ margin: '0 0 8px', fontSize: '28px', fontWeight: 500, color: '#1a1a18', lineHeight: 1.2 }}>
              ...
              <form onSubmit={handleSaveName} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div>
                  <label style={{ fontSize: '13px', color: '#6b6960', display: 'block', marginBottom: '8px' }}>Your name</label>
                  <input
                    type="text"
                    value={userName}
                ...
                <button type="submit" disabled={loading} style={{
                  width: '100%', padding: '16px', fontSize: '16px', fontWeight: 500,
                  color: 'white', background: loading ? '#9b9890' : '#1a1a18',
                  border: 'none', borderRadius: '22px',
                ...
                <button type="button" onClick={() => setStep('chat')} style={{
                  background: 'none', border: 'none', cursor: 'pointer',
                  fontSize: '13px', color: '#9b9890', padding: '8px 0',
          ...
          {step === 'join' && (
            <div className="animate-fade-in-up">
              ...
              <p style={{ margin: '0 0 32px', fontSize: '15px', color: '#9b9890', lineHeight: 1.5 }}>
                Ask your admin to invite you — share your email address below.
              </p>

              {userEmail && (
                <button onClick={handleCopyEmail} style={{
                  width: '100%', background: 'white', borderRadius: '14px',
                  border: '0.5px solid rgba(0,0,0,0.07)', padding: '14px 16px',
                  display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                  cursor: 'pointer', fontFamily: 'inherit', marginBottom: '12px',
                  textAlign: 'left',
                }}>
                  <span style={{ fontSize: '14px', color: '#1a1a18' }}>{userEmail}</span>
                  <span style={{ fontSize: '12px', color: copied ? '#22c55e' : '#9b9890', fontWeight: 500, flexShrink: 0, marginLeft: '12px' }}>
                    {copied ? 'Copied!' : 'Copy'}
                  </span>
                </button>
              )}

              <div style={{ background: 'white', borderRadius: '16px', border: '0.5px solid rgba(0,0,0,0.07)', padding: '20px', marginBottom: '16px' }}>
