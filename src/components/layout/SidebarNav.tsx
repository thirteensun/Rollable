  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '0 18px 20px', display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{ width: 24, height: 24, borderRadius: 8, background: '#1a1a18', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
      ...
      <div style={{ padding: '0 10px', flex: 1 }}>
        ...
        } badge={3} badgeColor="#E24B4A">AI Sandbox</NavItem>

        <div style={{ fontSize: 10, color: '#9b9890', textTransform: 'uppercase', letterSpacing: '0.06em', padding: '0 8px', margin: '16px 0 4px' }}>
          CRM
        </div>

        <NavItem href="/deals" active={isActive('/deals')} icon={
          <svg viewBox="0 0 15 15" fill="none" stroke="currentColor" strokeWidth="1.4">
            <path d="M1.5 7.5h12M7.5 1.5l6 6-6 6" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        }>Deals</NavItem>
...
function NavItem({
  href, active, icon, badge, badgeColor, children,
}: {
  href: string
  active: boolean
